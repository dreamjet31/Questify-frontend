...
import { LeaderItemType } from "../../Betting/LeaderItem";
...
const DJRecentScoreList = (props: DetailedLeaderItemType) => {
  ...
  return (
    <li
      className=" text-[#E5E7EB] font-500 border-[#313239] border-b lg:text-[14px] text-[12px] 
      py-[6px] px-[10px] lg:pl-[40px] pl-[20px] pr-0 flex items-center mb-2 gap-4 overflow-scroll font-[IBMPlexMono-Regular]"
    >
      {!isSmallDevice && (
      ...
      <div className="w-[15%] justify-center">
        <div className="w-[50px] justify-center items-center">
          <img
            src="/images/betting/DJ.svg"
            alt="avatar"
            className="rounded-[10px] h-[34px]"
          />
        </div>
      </div>
...
export default DJRecentScoreList;
